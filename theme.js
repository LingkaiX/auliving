    ...
    jQuery.getJSON(url + "&offset=" + postOffset, function (data) {
      if (data.length > 0) {
        ...
        jQuery.each(data, function (key, val) {
          var s = '<div class="listed-post"><a class="cover-img" href="' + val.link + '" style="background-image:url(' + "'" + val.cover_img + "'" + ');"><div class="post-info"><a href="' + val.link + '"><h4 class="title">' + val.title.rendered + '</h4></a><h6 class="sub-title">' + val.excerpt.rendered + '</h6><span class="date-info">' + val.date_info + "</span></div></div>";
          posts.push(s);
        });
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + '57717' + '/');
